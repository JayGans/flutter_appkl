...
class Collect extends StatelessWidget {
  ...
  PdfGrid getGrid() {
    ...
    headerRow.cells[0].value = 'Particular Name';
    headerRow.cells[0].stringFormat.alignment = PdfTextAlignment.center;
    headerRow.cells[1].value = 'Units';
    headerRow.cells[2].value = 'Unit Cost';
    headerRow.cells[3].value = 'Cost';

    addProducts('Electricity Bill', 1, 300, 300, grid);
    addProducts('Security Staff', 1, 800, 800, grid);
    addProducts('Office Exp', 1, 200, 200, grid);
...
//Create and row for the grid.
  void addProducts(String productName, double unit,
      double unitcost, double total, PdfGrid grid) {
    PdfGridRow row = grid.rows.add();
    row.cells[0].value = productName;
    row.cells[1].value = unit.toString();
    row.cells[2].value = unitcost.toString();
